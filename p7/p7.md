...
- RM (Rate Monotonic) cuando Di = Ti.
- DM (Deadline Monotonic) cuando Di <= Ti.
...
La condición es suficinete pero no necesaria.
...
La condición es suficinete y necesaria.
...
Como mínimo el mayor de los periodos del conjunto de tareas.

***b\) Si se utiliza un planificador de prioridades dinámicas.***

Como mínimo el hiperperiodo.
...
$\longrightarrow R_{τ3}^4 = R_{τ3}^5 = 17 \leq 17 \text{(OK)}$

***b\) Utilizando su correspondiente cronograma.***

![](ejer6b.png "ejer6b") (OK)
